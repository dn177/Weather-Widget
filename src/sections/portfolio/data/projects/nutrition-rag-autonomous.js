...
const project = {
  ...
  "description": "A self-updating personal nutrition knowledge base. A nightly daemon walks the Obsidian vault, fetches new biomedical literature from Europe PMC for every food/supplement/compound in the stack, summarises each abstract through a local Qwen3.6-35B on vLLM, writes structured Markdown notes, commits and pushes to a private Forgejo repo — and a Forgejo Action diffs the push and reindexes only the changed files into OpenWebUI's BGE-M3 hybrid RAG. End-to-end on-premise; no third-party API except PubMed.",
  "detailedContent": {
