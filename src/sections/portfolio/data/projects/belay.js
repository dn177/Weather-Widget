    ...
    "sections": [
      ...
      },
      {
        ...
        "items": [
          ...
          "Stuck on one spot? Point-and-annotate (⌘⇧A): drag a box over part of the environment and Belay attaches just that region to the chat, so you can ask \"what's wrong here?\" about an exact place. It's a crisp native capture on desktop, an in-frame capture on the web",
      ...
      },
      {
        ...
        "items": [
          "The learning pane hosts documents, not just generated exercises: import a PDF and it becomes a host-rendered pdf.js reader built for the read-a-paper-and-ask loop, where you drag a box over a formula or figure and that page region goes to a vision model, with the answer landing in chat while the paper stays open",
      ...
      {
        "title": "Verify → Self-Repair: a Reviewer That Generalizes",
        "items": [
      ...
      },
      {
        ...
        "items": [
          ...
          "An evasion-aware red-team pass closed three real bypass classes: CSS-escape evasion (a url() smuggled behind unicode escapes) decoded before matching, var()-fallback / custom-property smuggling caught by a string backstop, and namespaced selectors stripped. Each is pinned as a regression test (an 11-case suite), so a refactor can't quietly reopen the hole"
        ]
      },
      {
