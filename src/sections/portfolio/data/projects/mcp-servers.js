...
const project = {
  ...
  "detailedContent": {
    "overview": "MCP exposes capabilities to LLM clients as discoverable tools. These servers cover a niche the community didn't: tight feedback loops between an LLM-generated UI and a target design — measure, compare, overlay, and extract colours, all from inside the model's tool list.",
    "sections": [
      {
