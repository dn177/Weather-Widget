...
const Header = () => {
  ...
  useEffect(() => {
    if (isIntersecting && crownRef.current) {
      crownRef.current.classList.add("intersect");
    } else if (crownRef.current) {
      crownRef.current.classList.remove("intersect");
    }
  }, [isIntersecting]);
